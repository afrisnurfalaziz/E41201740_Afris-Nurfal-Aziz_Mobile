...
public class AdapterData extends RecyclerView.Adapter<AdapterData.HolderData> {
    ...
    public class HolderData extends RecyclerView.ViewHolder {
        ...
        public HolderData(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    dialogPesan.setMessage("Silahkan Pilih:");
                    dialogPesan.setCancelable(true);

                    idAnggota = Integer.parseInt(tvId.getText().toString()); // Foreign key
                    ...
                    dialogPesan.setPositiveButton("Delete", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            handler.postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    ((RetrofitActivity) context).retrieveData(); // Membuat fungsi refresh pada saat data di hapus
                                }
                            }, 1000); // Memberikan jeda waktu selama 1 detik
        ...
        private void deleteData() {
            APIRequestData ardData = RetroServer.konekRetrofit().create(APIRequestData.class); // Mengkoneksikan class interface dengan retrofit
            Call<ResponseModel> hapusData = ardData.ardDeleteData(idAnggota); // Membuat fungsi hapus berdasarkan nomor telepon
            ...
            hapusData.enqueue(new Callback<ResponseModel>() {
                ...
                public void onFailure(Call<ResponseModel> call, Throwable t) {
                    Toast.makeText(context, "Gagal Untuk Hapus Data: " +t.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        }
        ...
        private void getData() {
            ...
            ambilData.enqueue(new Callback<ResponseModel>() {
                ...
                public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                    ...
                    Intent kirim = new Intent(context, UpdateActivity.class); // Mengirim data menuju Update Data Activity
                ...
                @Override
                public void onFailure(Call<ResponseModel> call, Throwable t) {
                    Toast.makeText(context, "Gagal Untuk Menghubungkan ke Server: " +t.getMessage(), Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
